import 'package:atelier3/model/contact.service.dart';
...
class AjoutModifContactPage extends StatefulWidget {
  const AjoutModifContactPage({super.key, this.contact, this.modifMode = false});
      ...
      bottomNavigationBar: SizedBox(
        ...
        child: Row(
          ...
          children: [
            ...
            }, borderRadius: 10, btnColor: Colors.green, borderColor: Colors.green),
            FormHelper.submitButton("Annuler", () {
              Navigator.pop(context);
            }, borderColor: Colors.grey, borderRadius: 10, btnColor: Colors.grey),
          ],
        ),
      ),
    );
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            FormHelper.inputFieldWidgetWithLabel(context, "tel", "Telephone", "", (onValidate) {
              if (onValidate.isEmpty) {
                return "* Required";
              }
              return null;
